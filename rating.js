module.exports = {
    get_rating: function (food) {
        ...
        var bad_foods = [
            ...
            "kookoscurrykala", "Appelsiinitofu", "Quorn-makaronilaatikko", "Quorn",
            "Taco-broilerivuoka", "broilerivuoka", "Mifu", "Mifu-pinaattikiusaus",
            "Mifu-pinaatti", "kiusaus", "possuhöystö", "possu", "höystö"
        ];
